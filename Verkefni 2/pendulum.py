    ...
    for pendular in pendulalist:
        for upphafsstada in upphafsstodur:
            ...
            for i in range(6 + 1):
                ...
                n = 100 * 2 ** i
                y1, y2 = follin.RKmethod2(f1=p.double_pendulum1, f2=p.double_pendulum2, horn1=pi_[upphafsstada[0]],
                                          horn2=pi_[upphafsstada[2]],
                                          hornhradi1=upphafsstada[1], hornhradi2=upphafsstada[3], fjoldiskrefa=n,
                                          lengd=20)
